...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org_name, mock_get):
        """ A test that GithubOrgClient.org returns the correct value """
    ...
    def test_public_repos_url(self):
        """ script to unit-test GithubOrgClient._public_repos_url """
    ...
    """The inputs to test the functionality """
    @parameterized.expand([
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self):
        """A method to test GithubOrgClient.public_repos """
        test_class = GithubOrgClient("holberton")
        assert True

    def test_public_repos_with_license(self):
        """A method to test the public_repos with the argument license """
        test_class = GithubOrgClient("holberton")
        assert True
